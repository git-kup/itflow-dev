...
$sql_settings = mysqli_query($mysqli, "SELECT config_azure_client_id, config_azure_client_secret, config_client_portal_enable,
    ...
    config_ticket_ordering, config_ticket_prefix, config_ticket_timer_autostart, config_ticket_timer_clocked_out_minutes, config_ticket_timer_mode,
...
$config_ticket_timer_mode = intval($row['config_ticket_timer_mode']);
$config_ticket_timer_clocked_out_minutes = intval($row['config_ticket_timer_clocked_out_minutes']);
