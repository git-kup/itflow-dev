...
if (isset($_POST['edit_ticket_settings'])) {
    ...
    $config_ticket_timer_mode = intval($_POST['config_ticket_timer_mode']);
    $config_ticket_timer_clocked_out_minutes = intval($_POST['config_ticket_timer_clocked_out_minutes']);

    mysqli_query($mysqli,"UPDATE settings SET config_ticket_prefix = '$config_ticket_prefix', config_ticket_next_number = $config_ticket_next_number, config_ticket_email_parse = $config_ticket_email_parse, config_ticket_email_parse_unknown_senders = $config_ticket_email_parse_unknown_senders, config_ticket_autoclose_hours = $config_ticket_autoclose_hours, config_ticket_new_ticket_notification_email = '$config_ticket_new_ticket_notification_email', config_ticket_default_billable = $config_ticket_default_billable, config_ticket_default_view = $config_ticket_default_view, config_ticket_moving_columns = $config_ticket_moving_columns, config_ticket_ordering = $config_ticket_ordering, config_ticket_timer_autostart = $config_ticket_timer_autostart, config_ticket_timer_mode = $config_ticket_timer_mode, config_ticket_timer_clocked_out_minutes = $config_ticket_timer_clocked_out_minutes WHERE company_id = 1");
